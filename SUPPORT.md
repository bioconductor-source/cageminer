...
Thanks for using `cageminer`! Before filing an issue, there are a few
...
ask](https://www.tidyverse.org/help/#where-to-ask). See also the
[Bioconductor help](http://bioconductor.org/help/) website.

- If it’s a question: start with
  [community.rstudio.com](https://community.rstudio.com/), and/or
  StackOverflow. If this a Bioconductor-related question, please ask it
  at the [Bioconductor Support
  Website](https://support.bioconductor.org/) using the [appropriate
  package tag](https://support.bioconductor.org/t/cageminer) (the
  website will send an automatic email to the package authors). There
  are more people there to answer questions.

- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/almeidasilvaf/cageminer/issues/new).
...
requests](https://github.com/almeidasilvaf/cageminer/issues) to make
